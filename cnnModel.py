...
from keras.layers import Dense, Conv1D, Flatten, Reshape, Dropout
...
def get_model(appliance, input_tensor, window_length, transfer_dense=False, transfer_cnn=False,
    ...
    dropout1 = Dropout(0.5)(cnn1)
    
    cnn2 = Conv1D(filters=30,
                  kernel_size=8,
                  strides=1,
                  padding='same',
                  activation='relu',
    ...
    dropout2 = Dropout(0.5)(cnn2)

    cnn3 = Conv1D(filters=40,
                  kernel_size=6,
                  strides=1,
                  padding='same',
                  activation='relu',
    ...
    dropout3 = Dropout(0.5)(cnn3)

    cnn4 = Conv1D(filters=50,
                  kernel_size=5,
                  strides=1,
                  padding='same',
                  activation='relu',
    ...
    dropout4 = Dropout(0.5)(cnn4)

    # cnn5 = Conv1D(filters=50,
    #               kernel_size=5,
    #               strides=1,
    #               padding='same',
    #               activation='relu',
    ...
    # dropout5 = Dropout(0.5)(cnn5)

    flat = Flatten(name='flatten')(dropout4)
    ...
    d_out = Dense(1, activation='sigmoid', name='output')(label)
