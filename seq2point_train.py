...
def get_arguments():
    ...
    parser.add_argument('--save_dir',
                        type=str,
                        # default='./trained_model_class',
                        default='./trained_mode',
...
# cost = -tf.reduce_mean(y_ * tf.log(tf.clip_by_value(y,1e-10,1.0))+(tf.constant(1.)-y_) * tf.log(tf.clip_by_value(tf.constant(1.)-y,1e-10,1.0)))
